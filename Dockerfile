...
RUN wget https://dl.google.com/edgedl/android/studio/ide-zips/4.2.1.0/android-studio-ide-202.7351085-linux.tar.gz \
    && tar -xvf android-studio-ide-202.7351085-linux.tar.gz -C /opt/ \
    && rm -rvf android-studio-ide-202.7351085-linux.tar.gz
